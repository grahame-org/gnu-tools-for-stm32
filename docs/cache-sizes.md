...
### Stage caches (`stage-v3-*` key prefix)
...
| --- | --- | --- | --- | --- |
| `stage-v3-<binutils-hash>` | `build-binutils` | `install-native` | 33,904,681 | 32.3 |
| `stage-v3-<gcc-first-hash>` | `build-gcc-first` | `install-native` | 336,301,240 | 320.8 |
| `stage-v3-<newlib-hash>` | `build-newlib` | `install-native` | 394,863,699 | 376.6 |
| `stage-v3-<newlib-nano-hash>` | `build-newlib-nano` | `build-native/target-libs` | 50,305,354 | 48.0 |
| `stage-v3-<gcc-final-hash>` | `build-gcc-final` | `install-native` | 890,962,404 | 849.9 |
| `stage-v3-<gcc-size-libstdcxx-hash>` | `build-gcc-size-libstdcxx` | `install-native` + `build-native/target-libs` | 1,937,959,379 | 1,848.1 |
| `stage-v3-<gdb-hash>` | `build-gdb` | `install-native` | 91,515,748 | 87.3 |
...
| --- | --- | --- | --- | --- | --- |
| `toolchain-v3-*` | `build-final` | `install-native` | 252,567,410 | 240.9 | No |
| `stage-v3-<final-hash>` (stage-final) | `build-final` | `install-native` | not yet measured | — | No |
...
The `toolchain-v3-*`, `stage-final`, and all `ccache-*` entries are correctly
